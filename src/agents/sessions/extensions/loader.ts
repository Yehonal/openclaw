...
import * as _bundledLlm from "openclaw/plugin-sdk/llm";
import * as _bundledLlmAnthropic from "openclaw/plugin-sdk/llm-anthropic";
import * as _bundledLlmBedrock from "openclaw/plugin-sdk/llm-bedrock";
import * as _bundledLlmGoogleShared from "openclaw/plugin-sdk/llm-google-shared";
import * as _bundledLlmOauth from "openclaw/plugin-sdk/llm-oauth";
import * as _bundledLlmOpenAiCodexResponses from "openclaw/plugin-sdk/llm-openai-codex-responses";
import * as _bundledLlmOpenAiCompletions from "openclaw/plugin-sdk/llm-openai-completions";
import * as _bundledLlmOpenAiResponses from "openclaw/plugin-sdk/llm-openai-responses";
import * as _bundledLlmProviderRuntime from "openclaw/plugin-sdk/llm-provider-runtime";
...
import * as _bundledAgentCore from "../../runtime/index.js";
...
import * as _bundledAgentSessions from "../index.js";
...
const VIRTUAL_MODULES: Record<string, unknown> = {
  ...
  "openclaw/plugin-sdk/agent-core": _bundledAgentCore,
  "@earendil-works/pi-tui": _bundledTui,
  "openclaw/plugin-sdk/llm": _bundledLlm,
  "openclaw/plugin-sdk/llm-anthropic": _bundledLlmAnthropic,
  "openclaw/plugin-sdk/llm-bedrock": _bundledLlmBedrock,
  "openclaw/plugin-sdk/llm-google-shared": _bundledLlmGoogleShared,
  "openclaw/plugin-sdk/llm-oauth": _bundledLlmOauth,
  "openclaw/plugin-sdk/llm-openai-codex-responses": _bundledLlmOpenAiCodexResponses,
  "openclaw/plugin-sdk/llm-openai-completions": _bundledLlmOpenAiCompletions,
  "openclaw/plugin-sdk/llm-openai-responses": _bundledLlmOpenAiResponses,
  "openclaw/plugin-sdk/llm-provider-runtime": _bundledLlmProviderRuntime,
  "openclaw/plugin-sdk/agent-sessions": _bundledAgentSessions,
};
